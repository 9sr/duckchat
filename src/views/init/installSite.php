        ...
        <div class="initDiv " style="margin-top:2rem;" >
            ...
            <div class="init_check_info margin-top5 " isLoad="<?php echo $isLoadOpenssl;?>">
                ...
                <div class="init_check_result">
                    <?php if($isPhpVersionValid){ echo " <img src='../../public/img/init/check_success.png' />
"; } else { echo "<img src='../../public/img//init/check_failed.png'  />" ;}?>
                </div>
            </div>
            ...
            <div class="init_check_info  ext_open_ssl" isLoad="<?php echo $isLoadOpenssl;?>" >
                ...
                <div class="init_check_result" >
                 <?php if($isLoadOpenssl==1){ echo " <img src='../../public/img/init/check_success.png'/>
"; } else { echo "<img src='../../public/img/msg/check_failed.png' />" ;}?>
                </div>
            </div>
            ...
            <div class=" init_check_info justify-content-left  ext_pdo_sqlite" isLoad="<?php echo $isLoadPDOSqlite;?>" >
                ...
                <div class="init_check_result">
                <?php if($isLoadPDOSqlite==1){ echo " <img src='../../public/img/init/check_success.png' />
"; } else { echo "<img src='../../public/img/msg/check_failed.png' />" ;}?>
                </div>
            </div>
            ...
            <div class="init_check_info justify-content-left ext_curl"  isLoad="<?php echo $isLoadCurl;?>" >
                ...
                <?php if($isLoadCurl==1){ echo " <img src='../../public/img/init/check_success.png'/>
"; } else { echo "<img src='../../public/img/msg/check_failed.png'  />" ;}?>
                </div>
            </div>
            ...
            <div class="init_check_info justify-content-left  ext_is_write"  isLoad="<?php echo $isWritePermission;?>" >
                ...
                <?php if($isWritePermission==1){ echo " <img src='../../public/img/init/check_success.png'/>
"; } else { echo "<img src='../../public/img/msg/check_failed.png'  />" ;}?>
                </div>
            </div>
            ...
            <div class="initHeader-sql">
                <div class="radioDiv" onclick="clickRadio('sqlite')">sqlite <span><img src="../../public/img/init/select.png"class="dbType radioImg sqliteRadio" data="sqlite" isSelected="1"> </span></div>
                <div class="radioDiv" onclick="clickRadio('mysql')">mysql <span><img src="../../public/img/init/un_select.png" class="dbType radioImg mysqlRadio" data="mysql" isSelected="0"></span> </div>
            </div>
            <div class="mysql-div">
                ...
                <div class="sql-setting mysql-setting">
                    <input type="text" class="sql-input sql-dbPort" placeholder="数据库端口号">
            ...
            <div class="sqlite-div">
                ...
                <select id="sqlite-file">
                    <option class="selectOption" fileName="">创建新的</option>
