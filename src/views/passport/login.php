    ...
    <div class="zaly_login zaly_login_by_pwd" >
        <div class="login_input_div" >
            ...
            <div class="login_name_div margin-top2">
                ...
                <input type="password" class="input_login_site phone_num  login_input_pwd" autocapitalize="off"  data-local-placeholder="enterPasswordPlaceholder"  onkeydown="loginPassportByKeyPress()" onkeypress="loginPassportByKeyPress()" placeholder="Please Enter Password" >
